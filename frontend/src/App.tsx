        ...
        <div className='max-w-[600px] md:min-w-[600px] min-w-[90vw]'>
          ...
          <Typewriter onInit={(t) => {
            t.pauseFor(100)
              ...
              .pauseFor(100)
              .typeString(`<br><br>I'm currently working as a Mobile Developer at <a class="underline" href="https://cbn.com/">CBN</a>, a faith-based organisation building world-class digital media app(Android, iOS, Roku & Web) experiences ranging from video streaming to guided learning experiences.`)
              .start();
          }} />
        </div>
      </div>
