...
func (_c *ArticleCreate) SetName(v string) *ArticleCreate {
	_c.mutation.SetName(v)
	return _c
}

// SetPublicationDate sets the "publicationDate" field.
func (_c *ArticleCreate) SetPublicationDate(v string) *ArticleCreate {
	_c.mutation.SetPublicationDate(v)
	return _c
}

// SetImage sets the "image" field.
func (_c *ArticleCreate) SetImage(v string) *ArticleCreate {
...
func (_c *ArticleCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "Article.name"`)}
	}
	if _, ok := _c.mutation.PublicationDate(); !ok {
		return &ValidationError{Name: "publicationDate", err: errors.New(`ent: missing required field "Article.publicationDate"`)}
	}
	if _, ok := _c.mutation.Image(); !ok {
		return &ValidationError{Name: "image", err: errors.New(`ent: missing required field "Article.image"`)}
	}
...
func (_c *ArticleCreate) createSpec() (*Article, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.PublicationDate(); ok {
